...
Original file is located at
    https://colab.research.google.com/drive/1gflpnRd7mdVZZ92uBIzQOGcfzCkzgHRL
"""
...
def punto_fijo(tolerancia):
  ...
  while i<nro_max_iteraciones:
    ...
    i=i+1
    p_anterior=p
  print ('El metodo del punto fijo diverge')
...
def main():
  ...
  semilla= (a+b)/2
  tolerancia1= 1e-5
  raiz1,iteracion1,lista1= punto_fijo(tolerancia1)
...
def verificacion_punto_fijo (a,b):
  j=a
  while j<=b:
    y= funcion_g(j)
    if a<=y and y<=b:
